function writeFrameAdvection(v, C, x, i, sim_params, C_ana, lim)
...
dt = sim_params.dt; dx = sim_params.dx; C0 = sim_params.C0; 
...
str = {['step: ' num2str(i)], ['dt: ' num2str(dt)], ['Steps: ' num2str(numberSteps)], ['C0: ' num2str(C0)]};
