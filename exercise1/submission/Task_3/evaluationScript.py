...
plt.title('Comparison double - float, resolution 64', size = 30)
plt.xlabel('number of iterations [-]', size=25)
plt.ylabel('error / residual [-]', size = 25)
...
plt.title('Comparison double - float, resolution 128', size = 30)
plt.xlabel('number of iterations [-]', size=25)
plt.ylabel('error / residual [-]', size = 25)
plt.rc('xtick', labelsize=25) 
plt.rc('ytick', labelsize=25)
...
plt.title('Comparison double - float, resolution 256', size = 30)
plt.xlabel('number of iterations [-]', size=25)
plt.ylabel('error / residual [-]', size = 25)
plt.rc('xtick', labelsize=25) 
plt.rc('ytick', labelsize=25)
...
plt.title('Comparison double - float, resolution 512', size = 30)
plt.xlabel('number of iterations [-]', size=25)
plt.ylabel('error / residual [-]', size = 25)
plt.rc('xtick', labelsize=25) 
plt.rc('ytick', labelsize=25)
